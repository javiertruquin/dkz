...
export default function TextoSitioWeb() {
  return (
    <div className="pt-xl-5 container">
      <div>
        <div>
          <p className="tamaño-medio my-5 px-5 peso-italic text-white text-center espaciado texto-sombra d-none d-sm-block ">
