  ...
  return (
    <div className="mt-5 padding-sitioconst container d-flex">
      <div className="col-8">
        ...
        <p className="text-white tamaño-grande mx-5 px-5">{subtitulo}</p>
        ...
        <div className="d-flex">
          <p className="text-white mt-1 mb-0">
            {textoImagen1} <hr className="color-verde-claro-fondo px-5" />
          </p>
        </div>

        <p className="text-white my-4 py-2 mx-5 px-5 tamaño-chico">{fecha} </p>
      ...
      <div className="col-4 ms-4">
        ...
        <p className="text-white tamaño-mas-grande peso-bold">
          ...
          <TrabajosPrensa />
              ...
              {/* <div onClick={reload}>
              {todosTrabajos.map((trb) => (
                    <NavLink className="d-flex mb-3 sin-sub" to={"/prensa/" + trb.id}>
                        <div className="col-3">
                            <Image
                                src={trb.imagenMini}
                                alt={trb.titular}
        ...
        {/* <NavLink className="d-flex mb-3 sin-sub" to={"/prensa/" + id}>
          <div className="col-3">
            <Image src={imagenMini} alt={titular} fluid />
          </div>
          <div>
            <p className="text-white peso-bold ms-3 ">{titular}</p>
          </div>
        </NavLink> */}
