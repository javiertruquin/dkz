  ...
  return (
    <>
      <div className="pb-4 color-azul-oscuro-fondo">
        <div className="fondo-banner-social-media-cel">
          <div className="card-position">
            ...
            <div className="banner-pie-social-media d-flex justify-content-center px-1">
              <div className="text-white">
                <p className="peso-italic tamaño-medio px-2 color-violeta-fondo-banner-pie rounded-3 ">
