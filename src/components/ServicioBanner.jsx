                    ...
                    <div className="card-position">
                        ...
                        <div className="banner-pie-cel d-flex justify-content-center color-violeta-fondo-banner-pie px-1 rounded-3">
                            <div className="text-white">
                                <p className="peso-italic tamaño-medio px-2 py-5 mb-0">
                                    En DKZ sabemos lo fundamental que es
                                    identificar estrategias, herramientas y
                                    nuevas tecnologías <br /> para el diseño y
                                    ejecución de diferentes piezas y proyectos
                                    publicitarios, cualquiera sea su índole y
                                    nivel abarcativo de proyección. Por esto
                                    resulta imprescindible realizar campañas
                                    exitosas y lograr un posicionamiento online
                                    acorde a la demanda de cada rubro.
                                </p>
                            </div>
                        </div>
                    </div>
