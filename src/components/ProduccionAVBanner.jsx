                    ...
                    <div className="card-position">
                        <div className="d-flex flex-column justify-content-center align-items-center">
                            <div className="my-5 mx-3">
                                <h1 className="titulos-impacto tamaño-mas-grande peso-bold-italic text-white text-center  mt-5 px-4">
                            ...
                            <Fade right>
                                <div className="text-white texto-creatividad mx-5 py-3">
                                    <p className="tamaño-medio peso-italic mb-0">
                                        Investigación, relevamiento, generación
                                        e interpretación del brief y las
                                        necesidades específicas de comunicación.
                                        Guión y propuesta creativa.
                                        Presupuestación.
                                    </p>
                                </div>
                            </Fade>
                            ...
                            <Fade right>
                                <div className="text-white texto-creatividad mx-5 py-3">
                                    <p className="tamaño-medio peso-italic mb-0">
                                        ...
                                        Realización de decorados. Casting. Make
                                        up, estilismo, vestuario.
                                    </p>
                                </div>
                            </Fade>
                        </div>
                            ...
                            <Fade bottom>
                                <div className="text-white texto-creatividad mx-5 py-3">
                                    <p className="tamaño-medio peso-italic mb-0 pb-5">
                                        ...
                                        Música y sonido. Corte final y copias
