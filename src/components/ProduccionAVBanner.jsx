                ...
                <div className="pb-4 color-azul-oscuro-fondo d-md-none d-block">
                    ...
                    <div className="d-flex justify-content-center">
                        <p className="tamaño-medio  peso-italic text-white espaciado texto-sombra px-5 text-center">
                            ...
                            <br />
                            -Desarrollo y solución completa llave en mano
                            (diseño + desarrollo + programación)
                            <br /> -Tecnologías utilizadas en nuestros
                            desarrollos: Linux + Apache + PHP + MySQL + React +
                            HTML 5 + CSS + Javascript <br /> -Análisis funcional
                            del sitio. <br /> -UX UI. <br /> -Sitios Responsive.{" "}
                            <br /> -Codificación SEO Y SEM . <br />{" "}
                            -Certificados SSL de seguridad. <br /> -Integración
                            de API´s y Webservices.
                        </p>
                    </div>
                </div>
            </div>
